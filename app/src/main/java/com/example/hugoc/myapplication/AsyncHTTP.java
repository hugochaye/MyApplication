...
public class AsyncHTTP extends AsyncTask<String, Integer, String> {
    ...
    public AsyncHTTP(AppCompatActivity a) {
        myActivity = a;
    }
    ...
    protected void onProgressUpdate(Integer... values) {
        ProgressBar pb = (ProgressBar) myActivity.findViewById(R.id.ProgresExplication);
        pb.setProgress(values[0]);

    }
    @Override
    protected void onPostExecute(String s) {
        TextView text = (TextView) myActivity.findViewById(R.id.Explication);
        text.setText(s);
        ProgressBar pb = (ProgressBar) myActivity.findViewById(R.id.ProgresExplication);
        pb.setProgress(100);
