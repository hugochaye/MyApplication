...
public class Skeleton extends AsyncTask<String, Integer, String> {

    private AppCompatActivity myActivity;
    public Skeleton(AppCompatActivity a) {
        myActivity = a;
    }
    ...
    protected String doInBackground(String... string) {
        ...
        try {
            url = new URL("https://en.wikipedia.org/w/api.php?format=json&action=query&prop=extracts&exintro&explaintext&redirects=1&titles=Skeleton");
            ...
            try {
                ...
                */
                ...
                result = Object2.getString("27609");
